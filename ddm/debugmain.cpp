...
int main()
{
    ...
    NILT dDILT(1);
    long double q=0.01l;
    long double vbar=5.0l;//gsl_vector_get(para, 1);
    ...
    cout << "begin \n";
    ILT.optimize_incre(-Dq2lambda, 0, -Dq2, 0, paraISF, 0.01l, 6000.0l);
    cout << ILT.increments[tid] << '\n';
    cout << ILT.estimate_Err(0.01l, 6000.0l) << '\n';
//    
//    ILT.weideman(-Dq2lambda, 0, -Dq2, 0, 0.1);
//    ILT.NiLT_weeks(paraISF);
//    cout << ILT.estimate_Err(0.01l, 6000.0l) << '\n';
//    
//    ILT.weideman(-Dq2lambda, 0, -Dq2, 0, 0.5);
//    ILT.NiLT_weeks(paraISF);
//    cout << ILT.estimate_Err(0.01l, 6000.0l) << '\n';
//    dvbarILT.optimize_incre(-Dq2lambda, 0, -Dq2, 0, paraISF, 0.01, 100000);
//    cout << dvbarILT.increments[tid] << '\n';
//    dsigmaILT.optimize_incre(-Dq2lambda, 0, -Dq2, 0, paraISF, 0.01, 100000);
//    cout << dsigmaILT.increments[tid] << '\n';
//    dlambdaILT.optimize_incre(-Dq2lambda, 0, -Dq2, 0, paraISF, 0.01, 100000);
//    cout << dlambdaILT.increments[tid] << '\n';
//    dDILT.optimize_incre(-Dq2lambda, 0, -Dq2, 0, paraISF, 0.01, 100000);
//    cout << dDILT.increments[tid] << '\n';
//    
//    //    cb2=cb*2;
//    //    csigmab=csigma-cb;
//    
...
//    ofstream dTTdebug("dTTdebug.txt");
    ...
    {
        long double t=pow(10,-2+(iter+1)*0.01l);
